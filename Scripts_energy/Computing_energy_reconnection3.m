...
% From here onwards is where using the other vec vector doesn't work. The followinf is the error 
%---------------------------------------------
...
%There is a further separation needed. The diagonal terms and the off
%diagonal terms to calculate their contributions and the Pi-D like terms
...
title('$B$','Interpreter','latex','FontSize',fs);
hold off
...
dtE_em_in_Gp_2  Div_Poyn_v_Gp, JdotE, 
%--------------------------------------------------------------------------
% --->  dtE_em_in_Gp_2  Div_Poyn_v_Gp, JdotE,    <-----
f14=figure(14);
h1=subaxis(1,3,1,'SV',0.01,'SH',0.004,'MR',0.01,'ML',0.05,'PL',0.01,'PR',0.006);
...
% Again, frist the plot for the kinetic energy.
