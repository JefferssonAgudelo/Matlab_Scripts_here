...
% For electrons
%--------------------------------------------------------------------------
cut_1d=ve_Gp{1,1}'; ve_1_1d=cut_1d(:,ypc_i); 
cut_1d=ve_Gp{1,2}'; ve_2_1d=cut_1d(:,ypc_i); 
cut_1d=ve_Gp{1,3}'; ve_3_1d=cut_1d(:,ypc_i); 
...
% pressure temrs
cut_1d=(Pij_e_Gp{1,1}' + Pij_e_Gp{2,2}' + Pij_e_Gp{3,3}')/3; pe_e_Gp_1d = cut_1d(:,ypc_i);
cut_1d=(Pij_e_Gp{1,2}' + Pij_e_Gp{2,1}')/2; Pi_era_Gp_1d = cut_1d(:,ypc_i);
cut_1d=(Pij_e_Gp{3,2}' + Pij_e_Gp{2,3}')/2; Pi_epa_Gp_1d = cut_1d(:,ypc_i);
cut_1d=(Pij_e_Gp{3,1}' + Pij_e_Gp{1,3}')/2; Pi_epr_Gp_1d = cut_1d(:,ypc_i);

% Parameter proxies
cut_1d= Zernitani_e_Gp{1,1}'; Zernitani_e_Gp_1d = cut_1d(:,ypc_i);
cut_1d= p_theta_e_Gp{1,1}'; p_theta_e_Gp_1d = cut_1d(:,ypc_i);
cut_1d= PiD_e_Gp{1,1}'; PiD_e_Gp_1d = cut_1d(:,ypc_i);

% collisionale terms
cut_1d=dtKe_in_Gp_2{1,1}' + ve_grad_Ke_Gp{1,1}' + ve_Div_Pet_Gp{1,1}' + ...
    Ke_Div_ve_Gp{1,1}' -qe_ne_ve_E_Gp{1,1}'; dum_pXIe_Gp_1d = cut_1d(:,ypc_i);
...
cut_1d=dtUe_in_Gp_2{1,1}' + ve_grad_Ue_Gp{1,1}' + dkQiik_05_e_Gp{1,1}' + ...
    ...
    Ke_Div_ve_Gp{1,1}' -qe_ne_ve_E_Gp{1,1}'); dum_pXI2e_Gp_1d=cut_1d(:,ypc_i);

% Density
cut_1d=ne_Gp{1,1}'; ne_Gp_1d=cut_1d(:,ypc_i);

%--------------------------------------------------------------------------

% For Ions
%--------------------------------------------------------------------------
cut_1d=vi_Gp{1,1}'; vi_1_1d=cut_1d(:,ypc_i); 
cut_1d=vi_Gp{1,2}'; vi_2_1d=cut_1d(:,ypc_i); 
cut_1d=vi_Gp{1,3}'; vi_3_1d=cut_1d(:,ypc_i); 

% Time derivatives
cut_1d=dtKi_in_Gp_2{1,1}'; dtKi_in_Gp_1d = cut_1d(:,ypc_i);
cut_1d=dtUi_in_Gp_2{1,1}'; dtUi_in_Gp_1d = cut_1d(:,ypc_i);

% Kinetic
%cut_1d=partialKi_Gp{1,1}'; %partialKi_1d = cut_1d(:,ypc_i);
cut_1d=vi_grad_Ki_Gp{1,1}'; vi_grad_Ki_1d = cut_1d(:,ypc_i);
cut_1d=vi_Div_Pit_Gp{1,1}'; vi_Div_Pit_1d = cut_1d(:,ypc_i);
cut_1d=Ki_Div_vi_Gp{1,1}'; Ki_Div_vi_1d = cut_1d(:,ypc_i);
cut_1d=qi_ni_vi_E_Gp{1,1}'; qi_ni_vi_E_Gp_1d = cut_1d(:,ypc_i);

% Thermal
%cut_1d=partialUe_Gp{1,1}'; partialUe_1d = cut_1d(:,ypc_i);
cut_1d=vi_grad_Ui_Gp{1,1}'; vi_grad_Ui_1d = cut_1d(:,ypc_i);
cut_1d=dkQiik_05_i_Gp{1,1}'; dkQiik_05_i_Gp_1d = cut_1d(:,ypc_i);
cut_1d=Pit_grad_vi_Gp{1,1}'; Pit_grad_vi_Gp_1d = cut_1d(:,ypc_i);
cut_1d=Pit_grad_vi_ii_Gp{1,1}'; Pit_grad_vi_ii_Gp_1d = cut_1d(:,ypc_i);
cut_1d=Pit_grad_vi_ij_Gp{1,1}'; Pit_grad_vi_ij_Gp_1d = cut_1d(:,ypc_i);
cut_1d=Ui_Div_vi_Gp{1,1}'; Ui_Div_vi_Gp_1d = cut_1d(:,ypc_i);
cut_1d=Div_Pis_dot_vi_Gp{1,1}'; Div_Pis_dot_vi_Gp_1d = cut_1d(:,ypc_i);
...
% pressure temrs
cut_1d=(Pij_i_Gp{1,1}' + Pij_i_Gp{2,2}' + Pij_i_Gp{3,3}')/3; pe_i_Gp_1d = cut_1d(:,ypc_i);
cut_1d=(Pij_i_Gp{1,2}' + Pij_i_Gp{2,1}')/2; Pi_ira_Gp_1d = cut_1d(:,ypc_i);
cut_1d=(Pij_i_Gp{3,2}' + Pij_i_Gp{2,3}')/2; Pi_ipa_Gp_1d = cut_1d(:,ypc_i);
cut_1d=(Pij_i_Gp{3,1}' + Pij_i_Gp{1,3}')/2; Pi_ipr_Gp_1d = cut_1d(:,ypc_i);

% Parameter proxies
cut_1d= Zernitani_i_Gp{1,1}'; Zernitani_i_Gp_1d = cut_1d(:,ypc_i);
cut_1d= p_theta_i_Gp{1,1}'; p_theta_i_Gp_1d = cut_1d(:,ypc_i);
cut_1d= PiD_i_Gp{1,1}'; PiD_i_Gp_1d = cut_1d(:,ypc_i);

% collisionale terms
cut_1d=dtKi_in_Gp_2{1,1}' + vi_grad_Ki_Gp{1,1}' + vi_Div_Pit_Gp{1,1}' + ...
    Ki_Div_vi_Gp{1,1}' -qi_ni_vi_E_Gp{1,1}'; dum_pXIi_Gp_1d = cut_1d(:,ypc_i);
...
cut_1d=dtUi_in_Gp_2{1,1}' + vi_grad_Ui_Gp{1,1}' + dkQiik_05_i_Gp{1,1}' + ...
    ...
    Ki_Div_vi_Gp{1,1}' -qi_ni_vi_E_Gp{1,1}'); dum_pXI2i_Gp_1d=cut_1d(:,ypc_i);

% Density
cut_1d=ni_Gp{1,1}'; ni_Gp_1d=cut_1d(:,ypc_i);
%--------------------------------------------------------------------------

% Magnetic field
cut_1d=B_Gp{1,1}'; B_1_1d=cut_1d(:,ypc_i); 
cut_1d=B_Gp{1,2}'; B_2_1d=cut_1d(:,ypc_i); 
cut_1d=B_Gp{1,3}'; B_3_1d=cut_1d(:,ypc_i); 
%--------------------------------------------------------------------------
